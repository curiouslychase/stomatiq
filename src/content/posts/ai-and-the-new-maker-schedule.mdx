...
The algebra of individual productivity has always been simple: multiply your focused hours by your skill level and the leverage your tools provide.
  ...
  <div class="flex flex-col rounded-3xl border border-foreground/12 bg-background-alt/50 p-6">
    <span class="text-[0.65rem] font-mono uppercase tracking-[0.14em] text-foreground/60">Maker Equation</span>
    ...
    <div class="mt-4 flex items-center gap-2 text-[0.65rem] font-mono uppercase tracking-[0.12em] text-foreground/50">
      ...
      <span>Protected focus, serial execution</span>
    </div>
  </div>
...
The manager's equation runs on different physics—impact flows from the quality and quantity of decisions, amplified through the people who execute them.
  ...
  <div class="flex flex-col rounded-3xl border border-foreground/12 bg-background-alt/50 p-6">
    <span class="text-[0.65rem] font-mono uppercase tracking-[0.14em] text-foreground/60">Manager Equation</span>
    <span class="mt-4 inline-flex items-center rounded-2xl border border-foreground/15 bg-background-alt px-6 py-4 text-center font-mono text-base font-bold uppercase tracking-[0.08em] text-foreground">
      Manager Output = (Decisions × Quality × Team Size)
    </span>
    <div class="mt-4 flex items-center gap-2 text-[0.65rem] font-mono uppercase tracking-[0.12em] text-foreground/50">
      <span class="inline-flex h-2 w-2 rounded-full bg-foreground"></span>
      <span>Coordination leverage, parallel through people</span>
    </div>
  </div>
...
<div class="my-10 overflow-hidden rounded-3xl border border-foreground/10 bg-background-alt/40 p-6 font-mono text-sm uppercase tracking-[0.08em] text-foreground">
  ...
  <div class="mt-6 space-y-6">
    <div>
      ...
      <div class="mt-3 h-2 rounded-full bg-foreground/10">
        <div class="h-full rounded-full bg-foreground/70" style="width: 100%;"></div>
      </div>
    </div>
    <div>
      <div class="flex items-baseline justify-between text-xs font-semibold">
      ...
      <div class="mt-3 h-2 rounded-full bg-foreground/10">
        <div class="h-full rounded-full bg-foreground" style="width: 3%; min-width: 10px;"></div>
      </div>
    </div>
    <div class="rounded-2xl bg-foreground/5 px-4 py-3 text-center text-xs font-semibold tracking-[0.1em]">
...
<div class="my-6 rounded-3xl border border-foreground/10 bg-background-alt/40 p-5 text-foreground">
  <div class="font-mono text-xs font-semibold uppercase tracking-[0.12em] text-foreground/80">Amdahl's Law Demo</div>
  <div class="mt-4 space-y-4 text-sm">
    <div>
      ...
      <div class="mt-2 h-2 rounded-full bg-foreground/10">
        <div class="h-full rounded-full bg-emerald-400/70" style="width: 90%;"></div>
      </div>
    </div>
    <div>
      <div class="flex items-baseline justify-between font-mono text-xs uppercase tracking-[0.08em]">
      ...
      <div class="mt-2 h-2 rounded-full bg-foreground/10">
        <div class="h-full rounded-full bg-red-400/70" style="width: 10%; min-width: 14px;"></div>
      </div>
    </div>
    <div class="flex flex-wrap items-center justify-between rounded-2xl bg-foreground/5 px-4 py-3 font-mono text-xs uppercase tracking-[0.12em]">
...
<div class="my-6 rounded-3xl border border-foreground/10 bg-background-alt/40 p-5 text-foreground">
  <div class="font-mono text-xs font-semibold uppercase tracking-[0.12em] text-foreground/80">Gustafson's Law Demo</div>
  <div class="mt-4 grid gap-4 text-sm">
    ...
    <div class="grid grid-cols-3 items-center gap-3 font-mono text-xs uppercase tracking-[0.08em]">
      ...
      <div class="col-span-2 h-2 rounded-full bg-foreground/10">
        <div class="h-full rounded-full bg-blue-400/80" style="width: 15%; min-width: 16px;"></div>
      </div>
    </div>
    <div class="grid grid-cols-3 items-center gap-3 font-mono text-xs uppercase tracking-[0.08em]">
      <span>4</span>
      <div class="col-span-2 h-2 rounded-full bg-foreground/10">
        <div class="h-full rounded-full bg-blue-400/80" style="width: 45%;"></div>
      </div>
    </div>
    <div class="grid grid-cols-3 items-center gap-3 font-mono text-xs uppercase tracking-[0.08em]">
      <span>16</span>
      <div class="col-span-2 h-2 rounded-full bg-foreground/10">
        <div class="h-full rounded-full bg-blue-400/80" style="width: 100%;"></div>
      </div>
    </div>
    <div class="rounded-2xl bg-foreground/5 px-4 py-3 font-mono text-xs uppercase tracking-[0.12em] text-foreground/80">
      <div class="flex items-center justify-between">
        <span>Outcome</span>
        <span class="text-base font-bold text-foreground">More scope, not just speed</span>
      </div>
    </div>
  </div>
</div>
