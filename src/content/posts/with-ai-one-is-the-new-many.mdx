...
<div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
  <div class="group relative overflow-hidden rounded-3xl border border-foreground/12 bg-background-alt/60 p-6 shadow-sm">
    <div class="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-foreground/30 via-foreground to-foreground/30 opacity-80"></div>
    <div class="flex items-center justify-between text-[0.65rem] font-mono uppercase tracking-[0.14em] text-foreground/60">
      <span>Law 01</span>
      <span>1967</span>
    </div>
    <div class="mt-5 text-lg font-semibold uppercase tracking-[0.08em] text-foreground">
      Conway's Law
    </div>
...
The traditional work equation was simple. Its successor assumes coordination is optional.

{" "}

<div class="flex flex-col rounded-3xl border border-foreground/12 bg-background-alt/50 p-6">
  <span class="text-[0.65rem] font-mono uppercase tracking-[0.14em] text-foreground/60">
    Legacy Equation
  </span>
  <span class="mt-4 inline-flex items-center rounded-2xl border border-foreground/15 bg-background-alt px-6 py-4 text-center font-mono text-base font-bold uppercase tracking-[0.08em] text-foreground">
    Output&nbsp;=&nbsp;People&nbsp;×&nbsp;Coordination&nbsp;×&nbsp;Time
  </span>
  <div class="mt-4 flex items-center gap-2 text-[0.65rem] font-mono uppercase tracking-[0.12em] text-foreground/50">
    <span class="inline-flex h-2 w-2 rounded-full bg-foreground/50"></span>
    <span>Sequential era physics</span>
  </div>
</div>
...
<div class="flex flex-col rounded-3xl border border-foreground/12 bg-background-alt/50 p-6">
  <span class="text-[0.65rem] font-mono uppercase tracking-[0.14em] text-foreground/60">
    Collapsed Team Equation
  </span>
  <span class="mt-4 inline-flex items-center rounded-2xl border border-foreground/15 bg-background-alt px-6 py-4 text-center font-mono text-base font-bold uppercase tracking-[0.08em] text-foreground">
    Output&nbsp;=&nbsp;Imagination&nbsp;×&nbsp;AI&nbsp;×&nbsp;Iteration&nbsp;Speed
  </span>
  <div class="mt-4 flex items-center gap-2 text-[0.65rem] font-mono uppercase tracking-[0.12em] text-foreground/50">
    <span class="inline-flex h-2 w-2 rounded-full bg-foreground"></span>
    <span>Parallel era physics</span>
  </div>
</div>
...
<div class="my-10 overflow-hidden rounded-3xl border border-foreground/10 bg-background-alt/40">
  ...
  <div class="grid gap-6 px-6 py-6 md:grid-cols-2">
    <div class="flex flex-col rounded-2xl border border-foreground/8 bg-background-alt/70 p-5">
      <span class="text-[0.7rem] font-mono uppercase tracking-[0.14em] text-emerald-500/80">
        Solo Builder + AI
      </span>
      <div class="mt-4 flex items-baseline justify-between font-mono text-sm uppercase tracking-[0.08em] text-foreground">
        <span>Daily Iterations</span>
      ...
      <p class="mt-4 text-xs leading-5 text-foreground/60">
        Rapid prompts, instant feedback, no coordination drag.
      </p>
    </div>
    <div class="flex flex-col rounded-2xl border border-foreground/8 bg-background-alt/70 p-5">
      <span class="text-[0.7rem] font-mono uppercase tracking-[0.14em] text-foreground/50">
        Traditional Team Sprint
      </span>
      <div class="mt-4 flex items-baseline justify-between font-mono text-sm uppercase tracking-[0.08em] text-foreground/80">
        <span>Weekly Iterations</span>
        <span class="text-lg font-bold">2</span>
      </div>
      <div class="mt-3 h-2 rounded-full bg-foreground/10">
        <div
          class="h-full rounded-full bg-foreground/30"
          style="width: 8%; min-width: 12px;"
        ></div>
      </div>
      <p class="mt-4 text-xs leading-5 text-foreground/60">
...
<div class="my-10 overflow-hidden rounded-3xl border border-foreground/12 bg-background-alt/50">
  <div class="border-b border-foreground/10 px-6 py-5">
    <div class="text-[0.65rem] font-mono uppercase tracking-[0.14em] text-foreground/60">Sovereign Domains Model</div>
    <p class="mt-3 text-sm leading-6 text-foreground/80">Federated ownership with AI acceleration. Each owner ships independently, composes cohesively.</p>
  </div>
  <div class="grid gap-6 px-6 py-8 md:grid-cols-3">
    <div class="flex flex-col rounded-2xl border border-foreground/10 bg-background-alt/70 p-5">
      <span class="text-xs font-mono uppercase tracking-[0.14em] text-foreground/60">Domain 01</span>
      <span class="mt-3 text-lg font-semibold uppercase tracking-[0.08em] text-foreground">API Owner</span>
      <ul class="mt-4 space-y-2 text-sm text-foreground/75">
        <li class="flex items-baseline gap-2"><span class="inline-flex h-1.5 w-1.5 rounded-full bg-foreground/60"></span><span>Defines and maintains service contracts</span></li>
        <li class="flex items-baseline gap-2"><span class="inline-flex h-1.5 w-1.5 rounded-full bg-foreground/60"></span><span>Runs autonomous test and deploy cycles</span></li>
        <li class="flex items-baseline gap-2"><span class="inline-flex h-1.5 w-1.5 rounded-full bg-foreground/60"></span><span>Publishes change logs as the interface</span></li>
      </ul>
    </div>
    <div class="flex flex-col rounded-2xl border border-foreground/10 bg-background-alt/70 p-5">
      <span class="text-xs font-mono uppercase tracking-[0.14em] text-foreground/60">Domain 02</span>
      <span class="mt-3 text-lg font-semibold uppercase tracking-[0.08em] text-foreground">Interface Owner</span>
      <ul class="mt-4 space-y-2 text-sm text-foreground/75">
        <li class="flex items-baseline gap-2"><span class="inline-flex h-1.5 w-1.5 rounded-full bg-foreground/60"></span><span>Shapes end-to-end user journeys</span></li>
        <li class="flex items-baseline gap-2"><span class="inline-flex h-1.5 w-1.5 rounded-full bg-foreground/60"></span><span>Generates variants and ships live experiments</span></li>
        <li class="flex items-baseline gap-2"><span class="inline-flex h-1.5 w-1.5 rounded-full bg-foreground/60"></span><span>Consumes APIs without handoffs</span></li>
      </ul>
    </div>
    <div class="flex flex-col rounded-2xl border border-foreground/10 bg-background-alt/70 p-5">
      <span class="text-xs font-mono uppercase tracking-[0.14em] text-foreground/60">Domain 03</span>
      <span class="mt-3 text-lg font-semibold uppercase tracking-[0.08em] text-foreground">Operations Owner</span>
      <ul class="mt-4 space-y-2 text-sm text-foreground/75">
        <li class="flex items-baseline gap-2"><span class="inline-flex h-1.5 w-1.5 rounded-full bg-foreground/60"></span><span>Automates onboarding and support flows</span></li>
        <li class="flex items-baseline gap-2"><span class="inline-flex h-1.5 w-1.5 rounded-full bg-foreground/60"></span><span>Monitors feedback loops in real time</span></li>
        <li class="flex items-baseline gap-2"><span class="inline-flex h-1.5 w-1.5 rounded-full bg-foreground/60"></span><span>Closes loops with policy-driven playbooks</span></li>
      </ul>
    </div>
  </div>
  <div class="border-t border-foreground/10 px-6 py-4 text-center font-mono text-xs uppercase tracking-[0.12em] text-foreground/60">
    Composed via clear contracts, zero overlap
  </div>
</div>
