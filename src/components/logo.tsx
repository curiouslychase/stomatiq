...
export function Logo({ className, size = 48, animated = false }: LogoProps) {
  return (
    ...
    >
      ...
      <g className="diagonal diagonal-nw-to-top" style={{ transformOrigin: '305.821px 294.178px' }}>
        <ellipse cx="305.821" cy="294.178" rx="128.481" ry="88.1456" transform="rotate(-45 305.821 294.178)" fill="currentColor" />
      </g>
      <g className="diagonal diagonal-nw-to-left" style={{ transformOrigin: '305.821px 294.178px' }}>
        <ellipse cx="305.821" cy="294.178" rx="128.481" ry="88.1456" transform="rotate(-45 305.821 294.178)" fill="currentColor" />
      </g>
      <g className="diagonal diagonal-ne-to-top" style={{ transformOrigin: '838.924px 304.178px' }}>
        <ellipse cx="838.924" cy="304.178" rx="128.481" ry="88.1456" transform="rotate(45 838.924 304.178)" fill="currentColor" />
      </g>
      <g className="diagonal diagonal-ne-to-right" style={{ transformOrigin: '838.924px 304.178px' }}>
        <ellipse cx="838.924" cy="304.178" rx="128.481" ry="88.1456" transform="rotate(45 838.924 304.178)" fill="currentColor" />
      </g>
      <g className="diagonal diagonal-se-to-right" style={{ transformOrigin: '838.923px 827.281px' }}>
        <ellipse cx="838.923" cy="827.281" rx="128.481" ry="88.1456" transform="rotate(135 838.923 827.281)" fill="currentColor" />
      </g>
      <g className="diagonal diagonal-se-to-bottom" style={{ transformOrigin: '838.923px 827.281px' }}>
        <ellipse cx="838.923" cy="827.281" rx="128.481" ry="88.1456" transform="rotate(135 838.923 827.281)" fill="currentColor" />
      </g>
      <g className="diagonal diagonal-sw-to-bottom" style={{ transformOrigin: '305.821px 837.281px' }}>
        <ellipse cx="305.821" cy="837.281" rx="128.481" ry="88.1456" transform="rotate(-135 305.821 837.281)" fill="currentColor" />
      </g>
      <g className="diagonal diagonal-sw-to-left" style={{ transformOrigin: '305.821px 837.281px' }}>
        <ellipse cx="305.821" cy="837.281" rx="128.481" ry="88.1456" transform="rotate(-135 305.821 837.281)" fill="currentColor" />
      </g>
    </svg>
  );
