        ...
        >
          <div className="mx-auto h-full w-full max-w-2xl px-3 py-3">
            ...
            <nav
              ...
              style={{ fontFamily: 'var(--font-mono)' }}
            >
              <Link href="/newsletter" className="hover:underline" onClick={() => setMobileMenuOpen(false)}>Newsletter</Link>
              <Link href="/podcast" className="hover:underline" onClick={() => setMobileMenuOpen(false)}>Podcast</Link>
              <Link href="/products" className="hover:underline" onClick={() => setMobileMenuOpen(false)}>Products</Link>
              <Link href="/courses" className="hover:underline" onClick={() => setMobileMenuOpen(false)}>Courses</Link>
              <Link href="/consulting" className="hover:underline" onClick={() => setMobileMenuOpen(false)}>Consulting</Link>
              <Link href="/merch" className="hover:underline" onClick={() => setMobileMenuOpen(false)}>Merch</Link>
              <Link href="/rss.xml" className="hover:underline" onClick={() => setMobileMenuOpen(false)}>RSS</Link>
            </nav>
          </div>
        </div>
      )}
