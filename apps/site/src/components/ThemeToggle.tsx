...
type Theme = 'dark' | 'light' | 'vibe' | 'minimal-dark' | 'minimal-light' | 'system';
...
export default function ThemeToggle() {
  ...
  const applyTheme = (value: Theme) => {
    ...
    document.documentElement.classList.toggle('minimal-dark', theme === 'minimal-dark');
    document.documentElement.classList.toggle('minimal-light', theme === 'minimal-light');
  };
  ...
  return (
    ...
    >
      ...
      <ThemeButton
        theme="minimal-dark"
        label="MIN-D"
        isActive={currentTheme === 'minimal-dark'}
      ...
      <ThemeButton
        theme="minimal-light"
        label="MIN-L"
        isActive={currentTheme === 'minimal-light'}
        onClick={() => handleThemeChange('minimal-light')}
      >
        <svg
          viewBox="0 0 24 24"
          width="16"
